<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Companies.aspx.cs" Inherits="ACA_WebApplication.Companies" %>
                ...
                <table>
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <asp:DropDownList ID="drp_count" runat="server" AutoPostBack="True" CssClass="txt" OnSelectedIndexChanged="drp_count_SelectedIndexChanged">
