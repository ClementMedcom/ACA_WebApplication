                ...
                <ContentTemplate>
                    <div class="employer_form">
                        <ajaxToolkit:TabContainer CssClass="fancy fancy-green" ID="TabContainer1" runat="server">
                            <ajaxToolkit:TabPanel ID="generalinfotab" TabIndex="0" runat="server" Style="height:460px;">
                                <HeaderTemplate>
                                    General Information
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <asp:Panel ID="generalinfopanel" runat="server">
                                        <div class="gen_info">
                                            <table style="width:99%;height:440px; margin:0 auto;">
                                                <tr>
                                                    <td style="width:150px;">Employer Name</td>
                                                    <td colspan="3">
                            ...
                            <ajaxToolkit:TabPanel ID="cdetailstab" TabIndex="1" runat="server" Style="height:460px;">
                                <HeaderTemplate>
                                    1094 Details
                                </HeaderTemplate>
                                <ContentTemplate>
                                    <asp:Panel ID="cdetailspanel" runat="server">
                                        <div class="c_details">
                                            <table style="width:100%;"> 
                                                ...
                                                <tr>
                                                    <td colspan="6">
                                                        <table class="mon_table" style="width:100%;">
                                                            <thead>
                                                                <tr>
                                                                    <td>Month</td>
                                                            ...
                                                            <asp:Repeater ID="rpt_montable" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txt_full" Style="border: none; text-align: center;width:100%;height:100%;" MaxLength="1" Text='<%# Eval("full") %>' runat="server"></asp:TextBox></td>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txt_total" Style="border: none; text-align: center;width:100%;height:100%;" MaxLength="1" Text='<%# Eval("total") %>' runat="server"></asp:TextBox></td>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txt_section" Style="border: none; text-align: center;width:100%;height:100%;" MaxLength="1" Text='<%# Eval("section") %>' runat="server"></asp:TextBox>
                                                                        </td>
                                                                        <%--<td>
