            ...
            <div class="list" style="width:98%;margin:0 auto;">
               <table style="width:99%;">
                    <tr>
                        <td style="width:50%;float:left;">
                            <asp:TextBox ID="txtsearch" CssClass="srch"  AutoPostBack="true" runat="server" placeholder="Search"  OnTextChanged="txtsearch_TextChanged" Width="50%" Height="100%"></asp:TextBox>
             ...
             <span class="button-content">
                ...
                <div <%--style="overflow-y:auto;min-height:390px;max-height:453px;"--%>>
                        <table cellspacing="0" cellpadding="0" border="1" class="Repeater" rules="all" style="width: 100%;border-color:#b1c7ca;">
                            <tr>
                                <td>
                ...
                <tr>
                    <td>
                        <div style="width:100%; height:520.5px; overflow:auto;">
                            <table >
                                <tbody>
                                    <asp:Repeater ID="rptCompany" runat="server" OnItemCommand="rptCompany_ItemCommand" >
                                    <ItemTemplate>
                                <tr style="text-align: center;border:1px solid #b1c7ca;" class="thhover">
                                    <td style="width: 7%;">
