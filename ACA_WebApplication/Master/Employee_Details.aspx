...
>>>>>>> origin/master
                                            ...
                                            <div class="detail">
                                                ...
                                                <br />
                                                <b>S S N &nbsp;: </b> <asp:Label ID="lbl_ssn" runat="server" Text='<%# Eval("ssn") %>'></asp:Label>
                                 ...
                                 <div class="employee_info1">
                                     <table style="width: 95%; height: 100%;margin:0px auto;">
                                         <tr>
                                             ...
                                             <td colspan="3">
<<<<<<< HEAD
                                                 <asp:DropDownList ID="drp_employer" CssClass="cmb" style="width:99%;" runat="server">
=======
...
>>>>>>> origin/master
                                         ...
                                         <tr>
                                             <td>Full Name</td>
                                             <td>
                                                 <asp:TextBox ID="txt_firstname" placeholder="First Name" style="width:95%;" class="txt" runat="server"></asp:TextBox></td>
                                             <td>
                                                 <asp:TextBox ID="txt_middlename" placeholder="Middle Name" style="width:95%;" class="txt" runat="server"></asp:TextBox></td>
                                             <td>
                                                 <asp:TextBox ID="txt_lastname" placeholder="Last Name" style="width:95%;" class="txt" runat="server"></asp:TextBox></td>
                                         </tr>

                                         <tr>
                                              <td>Social Security Number</td><td>
<<<<<<< HEAD
                                                <asp:TextBox ID="txt_SSN" class="txt" style="width:95%;" runat="server"></asp:TextBox>
=======
...
>>>>>>> origin/master
                                             ...
                                             <td>
<<<<<<< HEAD
                                                 <asp:TextBox ID="txt_dob" class="txt" style="width:95%;" MaxLength="10" AutoComplete="off" placeholder="MM/dd/yyyy" runat="server"></asp:TextBox>
=======
...
<<<<<<< HEAD
                                     <table style="width: 100%; height:100%; border:1px solid gray;background-color:rgba(255,255,255, 0.6);" border="1">
=======
