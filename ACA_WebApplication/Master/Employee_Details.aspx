            ...
            <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
             ...
             <span class="button-content">
                <i class="glyph-icon icon-search font-white"></i>
                            ...
                            <asp:LinkButton class="btn medium bg-blue" ID="btn_refresh" style="border-radius:5px;padding:0px;margin-bottom:1px;" runat="server" OnClick="Refresh"><span class="button-content">
                <i class="glyph-icon icon-refresh font-white"></i>
            </span></asp:LinkButton>
                        <div style="overflow-y: auto; min-height: 470px; max-height: 470px; width: 100%; overflow-x: hidden;">
                        ...
                        <table>
                            <tr>
                                <td><asp:Label ID="lbl_result" runat="server" Text=""></asp:Label>
                           ...
                           <a href="javascript:;" class="btn medium bg-twitter" style="cursor:default;"><span class="glyph-icon icon-separator"><asp:Label ID="lbl_pagenum" runat="server" Font-Size="12px" Text="" ForeColor="White"></asp:Label></span></a>
                             ...
                             <div class="employee_form">
                                 <div class="employee_info1">
                                     <table style="width: 100%; height: 100%;">
                                         <tr>
                                             <td >Employer Name</td>
                                             <td colspan="3">
                                                 <asp:DropDownList ID="drp_employer" CssClass="cmb" style="width:93%;" runat="server">
                                                 </asp:DropDownList>
                                 ...
                                 <div style="width: 100%;float:left;display:inline-block;">
                                     <ajaxToolkit:TabContainer CssClass="fancy fancy-green" ID="TabContainer1" runat="server">
                                         <ajaxToolkit:TabPanel ID="tabinfo" TabIndex="0" Style="height:160px;" runat="server">
                                             <HeaderTemplate>
                                                 Information
                                             </HeaderTemplate>
                                             <ContentTemplate>
                                         ...
                                         <ajaxToolkit:TabPanel ID="tabHire" TabIndex="1" Style="height:160px;overflow-y:scroll;" runat="server">
                                             <HeaderTemplate>
                                                 Hire Data
                                             </HeaderTemplate>
                                             <ContentTemplate>
                                         ...
                                         <ajaxToolkit:TabPanel ID="tabStatus" TabIndex="2" Style="height:160px;overflow-y:scroll;" runat="server">
                                             <HeaderTemplate>
                                                 Status
                                             </HeaderTemplate>
                                             <ContentTemplate>
                                         ...
                                         <ajaxToolkit:TabPanel ID="tabcoverage" TabIndex="3" Style="height:160px;overflow-y:scroll;" runat="server">
                                             <HeaderTemplate>
                                                 Coverage
                                             </HeaderTemplate>
                                             <ContentTemplate>
                                         ...
                                         <ajaxToolkit:TabPanel ID="tabCoveredIndividual" TabIndex="4" Style="height:160px;overflow-y:scroll;" runat="server">
                                             <HeaderTemplate>
                                                 Covered Individual
                                             </HeaderTemplate>
                                             <ContentTemplate>
